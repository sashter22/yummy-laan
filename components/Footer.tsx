  ...
  return (
    ...
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col items-center text-center relative z-20">
          {/* Link Sosmed - Paksa Pointer Events & Z-Index Tinggi */}
          <div className="flex items-center space-x-6 mb-6 relative z-[50] pointer-events-auto">
            {/* WhatsApp */}
            <a
              href="https://wa.me/6289638727454"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#25D366] p-3 rounded-full hover:scale-110 active:scale-90 transition-all shadow-lg block relative z-[60]"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-600 p-3 rounded-full hover:scale-110 active:scale-90 transition-all shadow-lg block relative z-[60]"
              style={{ touchAction: "manipulation", cursor: "pointer" }}
