...
export default function Footer() {
  ...
  return (
    <footer
      id="footer"
      className="bg-[#3D1A0B] text-white pt-16 pb-12 px-6 relative z-10"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col items-center text-center">
          <div className="flex items-center space-x-6 mb-8 relative z-[50]">
            {/* WhatsApp */}
            <button
              type="button"
              onClick={() => handleSocialClick("https://wa.me/6289638727454")}
              className="bg-[#25D366] p-4 rounded-full hover:scale-110 active:scale-75 transition-all shadow-xl block cursor-pointer"
            ...
            <button
              ...
              onClick={() =>
                handleSocialClick(
                  "https://www.instagram.com/yummy.laan?igsh=dGswYzFkY256bmQy",
                )
              }
              className="bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-600 p-4 rounded-full hover:scale-110 active:scale-75 transition-all shadow-xl block cursor-pointer"
              style={{ touchAction: "manipulation" }}
            >
              <svg width="26" height="26" fill="white" viewBox="0 0 24 24">
