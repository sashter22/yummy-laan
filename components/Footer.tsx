export default function Footer() {
  return (
    <footer
      id="footer"
      className="bg-[#3D1A0B] text-white pt-16 pb-20 px-6 relative z-[10]"
    >
      <div className="max-w-6xl mx-auto">
        ...
        {/* Bagian Bawah: Sosmed */}
        <div className="mt-20 pt-10 border-t border-white/10 flex flex-col items-center text-center relative z-[20]">
          {/* Container ini kita kasih padding gede biar area sentuhnya aman */}
          <div className="flex items-center justify-center gap-10 mb-10 w-full relative z-[999]">
            {/* WhatsApp - Link Murni */}
            <a
              href="https://wa.me/6289638727454"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-[#25D366] p-4 rounded-full shadow-2xl active:scale-75 transition-all block"
              style={{
                pointerEvents: "auto",
            ...
            {/* Instagram - Link Murni */}
            <a
              href="https://www.instagram.com/yummy.laan"
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-600 p-4 rounded-full shadow-2xl active:scale-75 transition-all block"
              style={{
                pointerEvents: "auto",
                WebkitTapHighlightColor: "transparent",
              }}
          ...
          <p className="text-orange-200/30 text-[10px] md:text-xs font-medium tracking-widest uppercase mb-4">
