export default function Footer() {
  return (
    <footer
      id="footer"
      className="bg-[#3D1A0B] text-white pt-16 pb-10 px-6 scroll-mt-10"
    >
      <div className="max-w-6xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-8">
          ...
          {/* Sisi Kanan: Stay Sweet (Sejajar Branding) */}
        ...
        {/* Bagian Bawah: Sosmed & Copyright (Tengah) */}
        <div className="mt-16 pt-8 border-t border-white/10 flex flex-col items-center text-center">
          <div className="flex items-center space-x-5 mb-5">
            ...
            <a
              ...
              className="bg-[#25D366] p-2.5 rounded-full hover:scale-110 transition-transform shadow-md"
            >
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="bg-gradient-to-tr from-yellow-500 via-red-500 to-purple-600 p-2.5 rounded-full hover:scale-110 transition-transform shadow-md"
            >
              <svg width="22" height="22" fill="white" viewBox="0 0 24 24">
